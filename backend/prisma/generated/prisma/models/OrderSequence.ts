...
export type OrderSequenceWhereInput = {
  ...
  key?: Prisma.StringFilter<"OrderSequence"> | string
...
export type OrderSequenceScalarWhereWithAggregatesInput = {
  ...
  key?: Prisma.StringWithAggregatesFilter<"OrderSequence"> | string
...
export type OrderSequenceOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "value", ExtArgs["result"]["orderSequence"]>
...
export interface OrderSequenceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const orderSequenceWithKeyOnly = await prisma.orderSequence.findMany({ select: { key: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many OrderSequences and only return the `key`
   * const orderSequenceWithKeyOnly = await prisma.orderSequence.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more OrderSequences and only return the `key`
   * const orderSequenceWithKeyOnly = await prisma.orderSequence.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface OrderSequenceFieldRefs {
  readonly key: Prisma.FieldRef<"OrderSequence", 'String'>
